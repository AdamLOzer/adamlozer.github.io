...
author: "Adam L. Ozer"
date: "2024-05-08"
image: blog_1_front_end_screenshot.jpg
...
<center>![A screenshot of the database's UI](blog_1_front_end_screenshot.jpg){width="100%"}</center>
...
<center>![Figure 1. Total e-newsletters sent per MP (among MPs active e-newsletters; n = 1840)](blog_1_per_mp_hist.jpg){width="85%"}</center>
...
<center>![Figure 3. Trends in e-newsletters per week for Conservative and Labour MPs](blog1_mp_per_week.jpg){width="100%"}</center>
...
Unfortunately, this brief descriptive look does not allow for a good assessment of causality (assuming there is a strong causal mechanism at play). Yet, it is not too much of a stretch to hypothesise that this pattern is influenced by the news cycle earlier this year and electoral incentives among Conservative MPs seeking to minimise local losses. It will surely be interesting to see how these patterns develop as the general election approaches. 
