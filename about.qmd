...
- Building and deploying machine learning models, such as a model forecasting the daily event counts in Urgent and Emergency Care Services and a clustering model identifying similar GP practices.
...
- Supporting the development of the SCW's infrastructure for developing and deploying data science.
...
- Developed, recruited, and managed the charity's largest fundraising event to date (Kilimanjaro trek) and various major events (Ride 100, Great North Run).
